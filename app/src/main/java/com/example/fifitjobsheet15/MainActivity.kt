package com.example.fifitjobsheet15
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tombol.setOnClickListener {
            Toast.makeText(this, "Fifit Sholikhatul Mufalah", Toast.LENGTH_SHORT).show()
        }
        ...
        tombolnis.setOnClickListener {
            Toast.makeText(this, "2989", Toast.LENGTH_SHORT).show()
        }
    }
}